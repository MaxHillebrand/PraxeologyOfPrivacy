...
However, the subjective value scale is ordinal, not cardinal, and thus the value of multiple distinct units of a mean cannot be the multiple of a single units' value. In a scenario where multiple means must be chosen in aggregate, the value of the aggregate is unique in its rank in the individuals subjective value scale.
...
The greater the supply of a good, the lower the marginal utility. The lower the supply of a good, the higher the marginal utility. When choosing between units of two good based on the supply available. The marginal utility is higher for that good which the actor prefers.
